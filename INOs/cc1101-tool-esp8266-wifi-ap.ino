...
static void exec(char *cmdline)
{
    ...
    else if (strcmp_P(command, PSTR("setmodulation")) == 0)
    {
        ...
        if (setting == 0)
            tcpclient.write("2-FSK");
        else if (setting == 1)
            tcpclient.write("GFSK");
        else if (setting == 2)
            tcpclient.write("ASK/OOK");
        else if (setting == 3)
            tcpclient.write("4-FSK");
        else if (setting == 4)
            tcpclient.write("MSK");
    ...
    else if (strcmp_P(command, PSTR("setsyncmode")) == 0)
    {
        ...
        if (setting == 0)
            tcpclient.write("No preamble");
        else if (setting == 1)
            tcpclient.write("16 sync bits");
        else if (setting == 2)
            tcpclient.write("16/16 sync bits");
        else if (setting == 3)
            tcpclient.write("30/32 sync bits");
        else if (setting == 4)
            tcpclient.write("No preamble/sync, carrier-sense");
        else if (setting == 5)
            tcpclient.write("15/16 + carrier-sense");
        else if (setting == 6)
            tcpclient.write("16/16 + carrier-sense");
        else if (setting == 7)
            tcpclient.write("30/32 + carrier-sense");
    ...
    else if (strcmp_P(command, PSTR("setadrchk")) == 0)
    {
        ...
        if (setting == 0)
            tcpclient.write("No adr chk");
        else if (setting == 1)
            tcpclient.write("Adr chk, no bcast");
        else if (setting == 2)
            tcpclient.write("Adr chk and 0 bcast");
        else if (setting == 3)
            tcpclient.write("Adr chk and 0 and FF bcast");
    ...
    else if (strcmp_P(command, PSTR("setpktformat")) == 0)
    {
        ...
        if (setting == 0)
            tcpclient.write("Normal mode");
        else if (setting == 1)
            tcpclient.write("Synchronous serial mode");
        else if (setting == 2)
            tcpclient.write("Random TX mode");
        else if (setting == 3)
            tcpclient.write("Asynchronous serial mode");
    ...
    else if (strcmp_P(command, PSTR("setlengthconfig")) == 0)
    {
        ...
        if (setting == 0)
            tcpclient.write("Fixed");
        else if (setting == 1)
            tcpclient.write("Variable");
        else if (setting == 2)
            tcpclient.write("Infinite");
        else if (setting == 3)
            tcpclient.write("Reserved");
    ...
    else if (strcmp_P(command, PSTR("brute")) == 0)
    {
        ...
        {
            tcpclient.write("Wrong parameters.\r\n");
        }
